...
@NamedQueries({
    ...
    , @NamedQuery(name = "Smartphone.findByImei", query = "SELECT s FROM Smartphone s WHERE s.imei = :imei")})
public class Smartphone implements Serializable {
    ...
    public Smartphone(Integer id, String imei) {
        this.id = id;
        this.imei = imei;
    }
    ...
    public String toString() {
        return "entity.Smartphone[ id=" + id + " ]";
    }
